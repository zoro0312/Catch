...
void ::Catch::HubPage::Connect(int connectionId, Platform::Object^ target)
{
    ...
    case 1:
        (safe_cast<::Windows::UI::Xaml::Controls::Hub^>(target))->SectionHeaderClick +=
            ref new ::Windows::UI::Xaml::Controls::HubSectionHeaderClickEventHandler(this, (void (::Catch::HubPage::*)(Platform::Object^, Windows::UI::Xaml::Controls::HubSectionHeaderClickEventArgs^))&HubPage::Hub_SectionHeaderClick);
        break;
    case 2:
